...
contract("MyStandardToken", function(accounts) {

//CREATION

    it("creation: should create an initial balance of 10000 for the creator", function(done) {
        MyStandardToken.new(10000, 'Simon Bucks', 1, 'SBX', {from: accounts[0]}).then(function(ctr) {
    ...
    it("creation: test correct setting of vanity information", function(done) {
      var ctr;
        MyStandardToken.new(10000, 'Simon Bucks', 1, 'SBX', {from: accounts[0]}).then(function(result) {
            ctr = result;
    ...
    it("creation: should succeed in creating over 2^256 - 1 (max) tokens", function(done) {
        //2^256 - 1
        MyStandardToken.new('115792089237316195423570985008687907853269984665640564039457584007913129639935', 'Simon Bucks', 1, 'SBX', {from: accounts[0]}).then(function(ctr) {
